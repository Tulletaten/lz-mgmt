...
custom_replacements = {
  ...
  */
  names = {
    ...
    # Resource names
    log_analytics_workspace_name            = "law-lz-management-$${starter_location_01}"
    ama_user_assigned_managed_identity_name = "uami-lz-management-ama-$${starter_location_01}"
    dcr_change_tracking_name                = "dcr-lz-change-tracking"
    dcr_defender_sql_name                   = "dcr-lz-defender-sql"
    dcr_vm_insights_name                    = "dcr-lz-vm-insights"
  }
